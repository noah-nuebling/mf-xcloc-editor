...
///         But this seems to work well (at least embedded in an `NSTableView` - where the width is fixed to the column width) [Oct 2025]
///
...
@implementation MFTextField
    ...
    - (NSSize) intrinsicContentSize {
        ...
        auto newResult = result;
        {
            ...
            newResult.height += 2.0; /// Without `+2`, the content shifts slightly up/down when MFTextField is in the tallest row and you add / remove lines from it. [Oct 2025]
        }
        return newResult;
    }
